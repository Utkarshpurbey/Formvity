...
/** Read intended path without clearing (used while resolving ids during restore). */
...
/** Restore deep-link URL before React effects fire (GitHub Pages 404 → *.html shell). */
