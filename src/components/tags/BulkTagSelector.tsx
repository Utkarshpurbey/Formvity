...
import { Spinner, PopoverPortal } from "../ui/index";
  ...
  return (
    <div className="relative inline-block text-left" ref={anchorRef}>
      ...
      <PopoverPortal
        ...
        width={288}
        className="rounded-xl border border-slate-200 bg-white p-3 shadow-xl ring-1 ring-slate-900/10 animate-in fade-in zoom-in-95 duration-100"
      >
